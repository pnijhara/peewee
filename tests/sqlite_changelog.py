...
class TestChangeLog(ModelTestCase):
    ...
    def assertChanges(self, changes, last_index=None):
        ...
        query = (
            CL.select(CL.action, CL.table, CL.changes)
            .order_by(CL.id)
            .offset(last_index)
        )
    ...
    def test_changelog(self):
        ...
        self.assertChanges(
            [
                (
                    "INSERT",
                    "person",
                    {"name": [None, "huey"], "dob": [None, "2010-05-01"]},
                ),
                (
                    "INSERT",
                    "person",
                    {"name": [None, "zaizee"], "dob": [None, "2013-01-01"]},
                ),
            ]
        )
        ...
        self.assertChanges(
            [
                (
                    "DELETE",
                    "person",
                    {"name": ["zaizee-x", None], "dob": ["2013-03-03", None]},
                )
            ]
        )
        ...
        self.assertChanges(
            [
                ("UPDATE", "note", {"content": ["huey1", "huey1-x"], "status": [1, 0]}),
                (
                    "INSERT",
                    "person",
                    {"name": [None, "mickey"], "dob": [None, "2009-08-01"]},
                ),
        ...
        self.assertChanges(
            [
                ...
                (
                    "DELETE",
                    "person",
                    {"name": ["mickey", None], "dob": ["2009-08-01", None]},
                ),
            ]
        )
    ...
    def test_changelog_details(self):
        ...
        self.assertChanges(
            [("UPDATE", "ct1", {"f1": ["v1", "v1-x"], "f2": [1, 2], "f3": [1.5, 2.5]})]
        )
        ...
        self.assertChanges(
            [
                (
                    "UPDATE",
                    "ct1",
                    {"f1": ["v1-x", "v1"], "f2": [2, None], "f3": [2.5, 1.5]},
                )
            ]
        )
