...
class TestHybridProperties(ModelTestCase):
    ...
    def test_expression(self):
        ...
        self.assertEqual(sorted((i.start, i.end) for i in query), [(1, 5), (2, 6)])
...
class TestHybridWithRelationship(ModelTestCase):
    ...
    def test_hybrid_with_relationship(self):
        data = (("a", (4, 3, 2, 1)), ("b", (1000, 300, 30, 7)), ("c", ()))
        ...
        query = (
            Order.select(Order.name, Order.quantity.alias("sql_qt"))
